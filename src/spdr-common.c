...
extern struct SPDR_Event_Arg uu_spdr_arg_make_double(const char* key, double value)
{
...
extern struct SPDR_Event_Arg uu_spdr_arg_make_str(const char* key, const char* value)
{
